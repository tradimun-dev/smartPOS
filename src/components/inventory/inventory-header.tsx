        ...
        <>
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p className="text-gray-500 text-sm">Monitor stok batch, expiry date, dan penerimaan barang</p>
                </div>
                ...
                <div className="flex gap-2 w-full sm:w-auto">
                    ...
                    >
                        <PackagePlus size={18} />
                        <span className="hidden sm:inline">Terima Barang</span>
                    </button>
                </div>
            </div>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm">
                    <div className="bg-white rounded-xl shadow-xl w-full max-w-lg overflow-y-auto max-h-[90vh]">
                        <div className="flex justify-between items-center p-6 border-b sticky top-0 bg-white">
                            <h2 className="text-lg font-bold text-gray-800">Penerimaan Barang (Inbound)</h2>
